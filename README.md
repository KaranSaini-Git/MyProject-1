...
Understanding folders, files, and project organization

Learning how to push code to GitHub and host using GitHub Pages
...
How to create and link different HTML files

How to style elements with CSS and adjust layouts

How Git works (commits, pushes, version control basics)
